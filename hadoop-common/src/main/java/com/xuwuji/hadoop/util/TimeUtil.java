package com.xuwuji.hadoop.util;
...
public class TimeUtil {
	...
	private static DateTimeFormatter getDateFormatter1() {
		return DateTimeFormat.forPattern("yyyy-MM-dd-HH:mm");
	}

	private static DateTimeFormatter getSimpleDateFormatter() {
		return DateTimeFormat.forPattern("yyyy-MM-dd");
	}

	private static DateTimeFormatter getMinutesDateFormatter() {
